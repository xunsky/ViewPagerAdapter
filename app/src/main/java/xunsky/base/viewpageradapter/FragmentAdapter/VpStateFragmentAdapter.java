...
public class VpStateFragmentAdapter extends FragmentStatePagerAdapter {
    List<Fragment> mDatas;
    List<CharSequence> mTitles;

    public VpStateFragmentAdapter(FragmentManager fm, List<Fragment> datas) {
        this(fm,datas,null);
    }

    public VpStateFragmentAdapter(FragmentManager fm, List<Fragment> datas, List<CharSequence> titles) {
        super(fm);
        mDatas = datas;
        mTitles = titles;
    }
